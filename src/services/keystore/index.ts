...
import { KeyStore, Crypto } from './types'
...
const createKeystore = (privatekey: string, password: string): string => {
...
const getKeystoreContent = (keystore: KeyStore | string, password: string): string | null => {
  let keystoreObj
